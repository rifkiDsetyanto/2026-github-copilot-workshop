...
const routes = [
  ...
  { path: '/goods-receipts/new', name: 'goods-receipts-create', component: GoodsReceiptCreatePage },
  { path: '/goods-receipts/:id', name: 'goods-receipts-detail', component: GoodsReceiptDetailPage, props: true },
];
